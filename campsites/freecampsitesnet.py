...
#         camp_info = (
#          soup.find_all(class_='postTitle')[0].text + '\n' +  #Name of campsite
#         soup.select("#overview_box_top_left")[0].text + '\n' +#Address
#         soup.select("#overview_box_top_right")[0].text.rstrip() + '\n' +#Management
#         soup.select("#overview_box_text_bottom")[0].text + #Notes
#         soup.select("#notes")[0].text.rstrip() + '\n'
#        # soup.select('#comment_wrapper') + '\n'
#         )
...
# def write_text_file(coordinates):
#     driver = open_driver(coordinates,headless=False)
#     free_camps = find_free_camps(driver)
#     message = create_message(free_camps,driver)
#     f = open("campsites/results.txt",'w')
#     f.write(message)
...
#          soup.find_all(class_='postTitle')[0].text + '\n' +  #Name of campsite
#         soup.select("#overview_box_top_left")[0].text + #Address
#         soup.select("#overview_box_top_right")[0] + #Management
#         soup.select("#overview_box_text_bottom")[0].text + #Notes
...
#     return camp_info #manipulate camp info
